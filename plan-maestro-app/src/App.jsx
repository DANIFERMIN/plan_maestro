...
const MILESTONES = [
  { id: "m1", date: "2026-06-01", label: "Depositar 5K → 30K base inversión 19%", area: "Finanzas", critical: true, phase: 0 },
  ...
  { id: "m18", date: "2031-06-01", label: "SALIR DE HP. Tomar ferretería. Abrir Lavandería #2", area: "Negocios", critical: true, phase: 2 },
...
const MONTHLY_SIM = [
  ...
  { m: "Jun 2026", inv: 30000, buf: 992, total: 30992 },
  { m: "Jul 2026", inv: 30000, buf: 1617, total: 31617 },
  { m: "Ago 2026", inv: 30000, buf: 2242, total: 32242 },
  { m: "Sep 2026", inv: 30000, buf: 3717, total: 33717 },
  { m: "Oct 2026", inv: 35000, buf: 192, total: 35192 },
  { m: "Nov 2026", inv: 35000, buf: 1746, total: 36746 },
  { m: "Dic 2026", inv: 35000, buf: 3300, total: 38300 },
  { m: "Ene 2027", inv: 35000, buf: 4954, total: 39954 },
  { m: "Feb 2027", inv: 40000, buf: 1608, total: 41608 },
  { m: "Mar 2027", inv: 40000, buf: 3341, total: 43341 },
  { m: "Abr 2027", inv: 45000, buf: 74, total: 45074 },
  { m: "May 2027", inv: 45000, buf: 1887, total: 46887 },
  { m: "Jun 2027", inv: 45000, buf: 4100, total: 49100 },
  { m: "Jul 2027", inv: 50000, buf: 1163, total: 51163 },
  { m: "Ago 2027", inv: 50000, buf: 3305, total: 53305 },
  { m: "Sep 2027", inv: 55000, buf: 1297, total: 56297 },
];
...
const POST_HP = [
  ...
  { year: 2032, income: 16114, expenses: 4170, surplus: 11944 },
  { year: 2033, income: 19479, expenses: 4170, surplus: 15309 },
  { year: 2034, income: 26162, expenses: 4170, surplus: 21992 },
  { year: 2035, income: 29187, expenses: 3770, surplus: 25417 },
  { year: 2036, income: 30594, expenses: 3500, surplus: 27094 },
];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a1a", color: "#e0e0e0", fontFamily: "'Outfit', sans-serif", padding: 0 }}>
      ...
      <div style={{ display: "flex", borderBottom: "1px solid #1a1a3e", background: "#0d0d20" }}>
        {["dashboard", "hitos", "finanzas", "post-hp", "calendario"].map(t => (
          <button key={t} onClick={() => setTab(t)} style={{
            ...
            {t === "dashboard" ? "📊" : t === "hitos" ? "🎯" : t === "finanzas" ? "💰" : t === "post-hp" ? "🚀" : "📅"} {t}
          </button>
        ))}
      </div>
      ...
      <div style={{ padding: "16px 20px", maxWidth: 800, margin: "0 auto" }}>
        ...
        {tab === "post-hp" && (<>
          ...
          <div style={{ background: "#12122a", borderRadius: 12, padding: 16, border: "1px solid #2a2a4a" }}>
            ...
            {[
              { year: 2031, biz: ["Renov Express ✓", "Ferretería ✓", "Coffee ✓", "Lav#1 ✓", "Lav#2 ⬆"] },
              { year: 2032, biz: ["Renov Express ✓", "Ferretería ✓", "Coffee ✓", "Lav#1 ✓", "Lav#2 ✓", "Chiquipark ⬆"] },
              { year: 2033, biz: ["Renov Express ✓", "Ferretería ✓", "Coffee ✓", "Lav#1 ✓", "Lav#2 ✓", "Chiquipark ✓", "Co-Aliment ⬆"] },
              { year: 2036, biz: ["Renov ✓", "Ferr ✓", "Coffee ✓", "Lav#1 ✓", "Lav#2 ✓", "Chiq ✓", "CoAl ✓", "Inv19% ✓"] },
            ].map(y => (
