...
const POST_HP = [
  { year: 2031, income: 14695, expenses: 4170, surplus: 10525 },
  { year: 2032, income: 19414, expenses: 4170, surplus: 15244 },
  { year: 2033, income: 24579, expenses: 4170, surplus: 20409 },
  { year: 2034, income: 32862, expenses: 4170, surplus: 28692 },
  { year: 2035, income: 36987, expenses: 3770, surplus: 33217 },
  { year: 2036, income: 39094, expenses: 3500, surplus: 35594 },
];
      ...
      <div style={{ padding: "16px 20px", maxWidth: 800, margin: "0 auto" }}>
        ...
        {tab === "post-hp" && (<>
          ...
          <div style={{ background: "#12122a", borderRadius: 12, padding: 16, border: "1px solid #2a2a4a" }}>
            ...
            {[
              { year: 2031, biz: ["Renov ✓", "Ferr+Herr ✓", "Coffee ✓", "Lav#1 ✓", "Trast ⬆", "EV ✓"] },
              { year: 2032, biz: ["Renov ✓", "Ferr+Herr ✓", "Coffee ✓", "Lav#1 ✓", "Trast ✓", "Chiq ⬆", "EV ✓", "Senior ⬆"] },
              { year: 2033, biz: ["Renov ✓", "Ferr+Herr ✓", "Coffee ✓", "Lav ✓", "Trast ✓", "Chiq ✓", "CoAl ⬆", "EV ✓", "Senior ✓"] },
              { year: 2036, biz: ["Renov ✓", "Ferr+Herr ✓", "Coffee ✓", "Lav ✓", "Trast ✓", "Chiq ✓", "CoAl ✓", "EV ✓", "Senior ✓", "Inv19% ✓"] },
            ].map(y => (
